...
# print(questify('What is up'))
# print(questifyAlt('What is up'))
...
print(catenateLoop(['Halo', 'Halo', 'Two']))
...
# print(letterScoreLoop('u', scrabbleScores))
...
print(wordScoreLoop('words', scrabbleScores))
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Exercise 5
...
# print(wordsWithScoreLambda(['hi', 'chloe'], scrabbleScores))
...
def wordsWithScoreLoop(dct, scores):
    ...
    ret = []
    for r in dct: 
        ret.append([r, wordScore(r, scores)])
    return ret

print(wordsWithScoreLoop(['hi', 'chloedos'], scrabbleScores))