...
class Test(unittest.TestCase):
    ...
    def test07(self):
        sequence = '11' * 64
        compress = hw6.compress(sequence)
        self.assertEqual(compress, '00000111110000011111000001111100000111110000000100')
        uncompress = hw6.uncompress(compress)
        self.assertEqual(uncompress, sequence)
        self.assertAlmostEqual(hw6.compression(sequence), 0.390625, 4)
            
    def test08(self):
        sequence = '1' * hw6.MAX_RUN_LENGTH + '1' * hw6.MAX_RUN_LENGTH + '1' * (64 - 2 * hw6.MAX_RUN_LENGTH)
        compress = hw6.compress(sequence)
